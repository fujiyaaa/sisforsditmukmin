        ...
        <div>
            ...
            <nav class="mt-8 px-4 space-y-3">
                ...
                <a href="{{ url('/guru/monitoring-sholat') }}"
                   ...
                   {{ request()->is('guru/monitoring-sholat*') ? 'bg-white/20 font-semibold' : '' }}">
                    <span>🕌</span>
                ...
                <a href="{{ url('/guru/setoran') }}"
                   class="flex items-center gap-3 px-5 py-4 rounded-2xl hover:bg-white/10 transition
                   {{ request()->is('guru/setoran*') ? 'bg-white/20 font-semibold' : '' }}">
                    <span>📖</span>
                ...
                <a href="{{ url('/guru/laporan-prestasi-pelanggaran') }}"
                   class="flex items-center gap-3 px-5 py-4 rounded-2xl hover:bg-white/10 transition
                   {{ request()->is('guru/laporan-prestasi-pelanggaran*') ? 'bg-white/20 font-semibold' : '' }}">
                    <span>🏅</span>
