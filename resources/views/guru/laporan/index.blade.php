...
<div class="space-y-8">
    ...
    <div class="bg-white rounded-3xl shadow-lg p-8">
        ...
        <form method="GET" action="{{ route('laporan.index') }}" class="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <tbody>
                    @forelse ($siswas as $siswa)
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="px-4 py-4">{{ $siswa->nis }}</td>
                            <td class="px-4 py-4 font-semibold">{{ $siswa->nama }}</td>
                            <td class="px-4 py-4">
                ...
                <div class="border rounded-2xl p-5 bg-[#F8FBF9]">
                    ...
                    @if ($laporan->tingkat)
                        <p class="text-sm text-gray-500 mt-3">
                            <strong>Tingkat:</strong> {{ $laporan->tingkat }}
                        </p>
                    @endif
